...
parser.add_argument("--adj",       type=float, default=0.,     help="Multipler for inv..")
...
parser.add_argument("--save-step", type=int,   default=20000,  help="Plot after # steps.")
parser.add_argument("--data",      type=str,
                    default='/local-scratch/rshu15/nerdd/training-64x64.mat', help="Data directory.")
parser.add_argument("--save",      type=str,
                    default='/scratch/users/rshu15/nerdd/', help="Save directory.")
