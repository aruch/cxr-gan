...
parser.add_argument("--i-size",    type=int,   default=128,    help="Image size")
...
parser.add_argument("--save-step", type=int,   default=10000,  help="Plot after # steps.")
parser.add_argument("--save",      type=str,
                    default='/scratch/users/rshu15/nerdd/128/', help="Save directory.")
