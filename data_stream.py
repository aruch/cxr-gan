...
class DataStream:
    ...
    def load_next_segment(self, random=True):
        ...
        self.image_idxs = np.random.permutation(seg_end-seg_start)
        self.cur_batch = 0
    ...
    def next_batch(self, timeout=1):
        ...
        batch_end = min(self.image_idxs.shape[0], batch_start + self.batch_size)
        ret = self.image_cache[self.image_idxs[batch_start:batch_end]]
        self.cur_batch += 1
